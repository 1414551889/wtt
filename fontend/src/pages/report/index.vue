          ...
          render: (h, params) => {
            ...
            let btnView = h('Button', {
              ...
              on: {
                click: () => {
                  //  此处查看--------------name = planView------------
                  this.$router.push({name: 'reportView', query: {id: params.row.id}})
                }
              }
            }, '查看')
            let btnEdit = h('Button', {
              ...
              on: {
                click: () => {
                  ...
                  this.$router.push({name: 'reportEdit', query: {id: params.row.id}})
                }
              }
            }, '编辑')
              ...
              on: {
                click: () => {
                  let config = {
                    ...
                    onOk: async function() {
                       try {
                        await api.report.publishOnlineBill({onlineBillId: params.row.id})
