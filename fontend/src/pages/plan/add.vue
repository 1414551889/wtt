    ...
    <Row>
      <Col span="12" offset="6">
        <Form ref="form" :model="formData" :rules="formRule" :label-width="100">
          ...
          <FormItem label="项目编号：" prop="projectNumber">
            <Input v-model="formData.projectNumber" placeholder="请输入项目编号"></Input>
          </FormItem>
          ...
          <FormItem label="上线时间：" prop="onlineTime">
            <Input v-model="formData.onlineTime" placeholder="请输入上线时间"></Input>
          </FormItem>
  ...
  data() {
    return {
      ...
      formRule: {
        ...
        remark: {required: true, message: '请填写备注(上线计划)!', trigger: 'blur'}
      }
    }
  },
  computed: {
